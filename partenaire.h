...
public:
    ...
    QSqlQueryModel *afficherpartenaire();
    bool supprimerpartenaire(int);
    bool modifierpartenaire();
    QSqlQueryModel* tri_nompartenaire();
    QSqlQueryModel* tri_nom_decroissantpartenaire();

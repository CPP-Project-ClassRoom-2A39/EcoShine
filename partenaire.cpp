...
QSqlQueryModel *Partenaire::afficherpartenaire()
{
...
bool Partenaire::modifierpartenaire() {
    QSqlQuery query;
...
QSqlQueryModel* Partenaire::tri_nompartenaire()
{
...
QSqlQueryModel* Partenaire::tri_nom_decroissantpartenaire()
{
    // Crée un modèle de requête SQL pour stocker les résultats
    QSqlQueryModel *model = new QSqlQueryModel();
